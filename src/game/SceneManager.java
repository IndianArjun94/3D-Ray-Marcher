...
// Central Anchor: Large Perfect Mirror Sphere
        this.sceneObjects.add(new Sphere(new Vec3(0.0, -1.0, -4.2), 1.1, new Vec3(255, 255, 255), 0.0));

// Low Foreground Pillars: Small flanking glossy spheres
        this.sceneObjects.add(new Sphere(new Vec3(-2.0, -2.2, -3.5), 0.5, new Vec3(255, 165, 0), 0.15)); // Glossy Orange (Left)
        this.sceneObjects.add(new Sphere(new Vec3(2.0, -2.2, -3.5), 0.5, new Vec3(0, 191, 255), 0.15));  // Glossy Deep Blue (Right)

// Mid-Ground Floating Elements: Medium semi-gloss spheres hovering high
        this.sceneObjects.add(new Sphere(new Vec3(-1.8, 1.3, -4.8), 0.7, new Vec3(238, 130, 238), 0.3)); // Violet (Upper Left)
        this.sceneObjects.add(new Sphere(new Vec3(1.8, 1.3, -4.8), 0.7, new Vec3(255, 255, 0), 0.3));   // Yellow (Upper Right)

// Deep Background Sentinels: Larger matte spheres tucked into the back corners
        this.sceneObjects.add(new Sphere(new Vec3(-3.0, -0.8, -6.0), 0.8, new Vec3(0, 255, 255), 0.6));   // Cyan (Deep Back Left)
        this.sceneObjects.add(new Sphere(new Vec3(3.0, -0.8, -6.0), 0.8, new Vec3(255, 20, 147), 0.6));  // Pink (Deep Back Right)
